...
- Engage in good faith, especially when disagreeing about governance
  proposals.
- Disclose conflicts of interest per `GOVERNANCE_CONSTITUTION.md` §12
  rather than let them go unstated.
- Avoid personal attacks, harassment, or discrimination in any
  project space (issues, PRs, discussions, governance forums).
- Respect the outcomes of the governance process defined in this
