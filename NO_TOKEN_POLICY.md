...
Celo-HaiTi does not have, and this repository must never introduce, a
Celo-HaiTi governance token, tokenomics, or investment product.
...
2. `USDm` is referenced only as Celo-HaiTi's stablecoin for treasury
...
3. No code in this repository may mint, issue, price, or create a
   market for a Celo-HaiTi-specific token.
